...
|:-------------:|:-------------------:|:-------------------------:|:----------:|:----------:|
|  2023.05.15 ~ now |   Freelance |    Made from scratch full website and mobile version |  SBS Engineering LLC  | in progress  |
|  2023.07.18 ~ 2024.02.18 |   Freelance |   Made secure REST API using best coding modern practices . Did major refactoring and improvements, team leading in other Defimoon and partner projects | Defimoon  | [kyc.systems](https://kyc.systems)     |
|  2022.01.02 ~ 2024.01.02 |   Freelance |    Made talon, info, statistics and operator systems for line.copy.spb.ru website |  OQ Print  | [copy.spb.ru](https://copy.spb.ru/)      |
|  2021.11.05 ~ 2022.04.22   |   Freelance  |   Node.js system with implementation of REST API CheckAdvisor     | CheckAdvisor       |   [checkAdvisor.ru](https://checkadvisor.ru/) | 
|  2019.08.02 ~ 2021.09.11   |   Freelance   |   Providing my software engineering services as self-employed    | – |  Conducted thorough analysis to identify and resolve system inefficiencies across a range of projects (React.js · Laravel · PHP · Node.js · Git · TypeScript · MySQL · Vue.js). |  
