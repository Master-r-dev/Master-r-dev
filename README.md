...
Created a web site to check the design of the site for various screen resolutions in JavaScript using jQuery for the institute
...
|  2020.11.15 ~ 2020.11.30 |  Education    |    Created a web site to check the design of the site for various screen resolutions in JavaScript using jQuery |  Moscow Polytechnic University  |     https://github.com/Master-r-dev/CheckResolutionRUS     |
